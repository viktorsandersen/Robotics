                                      ...
                                      const rw::math::Transform3D<>& baseTtool)
{
    ...
    for (unsigned int i = 0; i < tvec.size (); ++i) {
        ...
        // Jacobian starting at row 0 of the position part. Our Jacobian is 6x3 with a 3x3 position
        // part and a 3x3 rotation part. The addRotation functions the same way just with the
        // rotation part of the Jacobian.
